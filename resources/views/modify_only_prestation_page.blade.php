...
@section('fail_chanel')
    <a href="{{route('only_prestations')}}"><b> @lang('lang.my_prestation') </b> </a><span class="glyphicon glyphicon-chevron-right"> </span> <a href="{{route('modify_user_page', ['id' => $prestation->id])}}"> <b> @lang('lang.modify_prestation') : {{strtoupper($prestation->code)}}</b>  </a>
@endsection
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('modify_only_prestation')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
