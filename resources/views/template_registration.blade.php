...
<head>
  ...
  <!-- Favicons -->
  <!--<link href="{{asset('template-user/mamba/assets/img/favicon.png')}}" rel="icon">
  <link href="{{asset('template-user/mamba/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">-->
