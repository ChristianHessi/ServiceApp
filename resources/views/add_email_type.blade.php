...
@section('fail_chanel')
    <a href="{{route('all_email_type_page')}}"> <b> @lang('lang.notif_types') </b></a> </a><span class="glyphicon glyphicon-chevron-right"> </span> <a href="{{route('add_email_type_page')}}"> <b> @lang('lang.add_notif_type') </b>  </a>
@endsection
...
@section('content')
    ...
    <!--<div class="offset-md-2 offset-lg-2 col-md-8  col-lg-8 col-sm-12 offset-md-2 offset-lg-2">
        <form action="{{route('register_email_type')}}" method="post" class="form-group" autocomplete="off">
            @csrf
            <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2><small>  @lang('lang.add_notif_type') </small></h2>
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{route('register_email_type')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
