...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{asset('js_requirement/maxcdn.bootstrapcdn.com-bootstrap-4.4.1-js-bootstrap.min.js')}}"> </script>
        <script src="{{asset('js_requirement/ajax.googleapis.com-ajax-libs-jquery-3.4.1-jquery.min.js')}}"> </script>
        <script src="{{asset('js_requirement/maxcdn.bootstrapcdn.com-bootstrap-3.4.1-js-bootstrap.min.js')}}"> </script>
        <script src="{{asset('js_requirement/code.jquery.com-jquery-2.0.3.min.js')}}"> </script>
    ...
    <body class="body">
        <nav class="navbar   navbar-expand-sm navbar-dark bg-dark"   style="background-color: ; color: white;">
            <div class="container-fluid" style="font-size: 20px;">
                <div class="navbar-header">
                    <a href="{{route('template_base')}}"> ITGStore </a>
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse" >
                      ...
                      <ul class="nav navbar-nav navbar-right">
                            <li class=""><a href="{{route('all_users')}}"><b> @lang('lang.users') </b> </a></li>
                            <li><a href="{{route('all_role')}}"><b>@lang('lang.role_permissions')</b></a></li>

                            <li><a href="{{route('all_email_type_page')}}"><b>@lang('lang.email_type_onglet')</b></a></li>

                            <li><a href="{{route('all_email_template_page')}}"><b>@lang('lang.email_tmp_onglet')</b></a></li>

                            <li class="dropdown"><a class="dropdown-toggle eltnav" data-toggle="dropdown" href="#"> <span class="glyphicon glyphicon-user"></span> <b>  {{Auth::user()->surname}} </b></a>
                                <ul class="dropdown-menu" role="menu" style="font-size: 20px;">
                                    <li class=""><a href="{{route('change_your_profile')}}" class="eltnav"> @lang('lang.profil') </a></li>
                                    <li class="divider"></li>
                                    <li><a href="{{route('change_your_parameters')}}" class="eltnav"> @lang('lang.auth_settings')</a></li>
                                    <li class="divider"> </li>

                                    <li class="dropdown-submenu">
                                        <a class="test" tabindex="-1" href="#">@lang('lang.langue') <span class="caret"></span></a>
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="{{route('logout')}}" class="eltnav">  @lang('lang.logout') </a></li>
                                </ul>
                            </li>
                      </ul>
                </div>
