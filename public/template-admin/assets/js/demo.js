...
demo = {
    ...
    showSuccess: function(message, from, align) {
        color = 0;
    ...
    showInfo: function(message, from, align) {
        color = 1;
    ...
    showWarning: function(message, from, align) {
        color = 3;
    ...
    showError: function(message, from, align) {
        color = 4;
